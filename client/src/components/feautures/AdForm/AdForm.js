    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)} className="">
            ...
            <Form.Group className="mb-3" controlId="title" style={{ minWidth: '300px' }}>
                ...
                {errors.title && <small className='d-block form-text text-danger mt-2'>only a-z, A-Z, 1-9, .,!?$-*: are available</small>}
            </Form.Group>
            <Form.Group className="mb-3" controlId="content" style={{ minWidth: '300px' }}>
                ...
                {errors.content && <small className='d-block form-text text-danger mt-2'> only a-z, A-Z, 1-9, .,!?$-*: are available</small>}
            </Form.Group>
            <Form.Group className="mb-3" controlId="location" style={{ minWidth: '300px' }}>
                ...
                {errors.location && <small className='d-block form-text text-danger mt-2'>Only a-z, A-Z, 0-9, "-" are available</small>}
            </Form.Group>
